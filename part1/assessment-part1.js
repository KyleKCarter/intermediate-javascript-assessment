...
/////////////////
/* need to fix the chargers and mustangs remaining gas */
//////////////////
...
String.prototype.grammarPolice = function () {
  let arr1 = this.split(' ');
  let arr2 = []
  let mappedArr1 = arr1.map((a) => a.charAt(0).toUpperCase() + a.substring(1).toLocaleLowerCase())
  let newString = mappedArr1.join(' ');
  console.log(newString)
  return arr2.push(newString);
}

//maybe use a for loop instead of .map
